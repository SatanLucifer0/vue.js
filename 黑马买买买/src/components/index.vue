                ...
                <div class="wrap-box">
                    ...
                    <div class="left-220">
                        <ul class="side-img-list">
                            <li v-for="(tp,index) in topList" @click.prevent="todetail(tp)">
                                <div class="img-box">
                                    <label>{{index+1}}</label>
                                    <img :src="tp.img_url">
                                </div>
                                <div class="txt-box">
                                    <a href="/goods/show-98.html">{{tp.title}}}</a>
                                    <span>{{tp.add_time | formatTime('YYYY年MM月DD日')}}</span>
                                </div>
                            </li>
...
export default {
  ...
  created() {
    ...
    this.$axios.get(`site/goods/gettopdata/goods`).then(res=>{
      console.log(res.data.message.toplist);
